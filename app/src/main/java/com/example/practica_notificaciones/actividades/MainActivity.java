package com.example.practica_notificaciones.actividades;
...
public class MainActivity extends AppCompatActivity {
        ...
        broadcastReceiver = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(Config.REGISTRATION_COMPLETE)){
                    ...
                    Toast.makeText(getApplicationContext(), "Notificacion Push: " + mensaje,Toast.LENGTH_LONG).show();
    ...
    private void mostrarFirebaseId(){
        ...
        if (!TextUtils.isEmpty(regId)){
            ...
            txtRegId.setText("No existe una respuesta de firebase");
        }
    }
