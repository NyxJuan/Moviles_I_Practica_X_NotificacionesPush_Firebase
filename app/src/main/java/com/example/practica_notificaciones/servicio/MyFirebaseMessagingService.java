package com.example.practica_notificaciones.servicio;
...
import com.example.practica_notificaciones.actividades.MainActivity;
import com.example.practica_notificaciones.app.Config;
import com.example.practica_notificaciones.util.NotificationUtils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived( RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0){
            ...
            try{
                JSONObject jsonObjet = new JSONObject(remoteMessage.getData().toString());
                interpretarMensaje(jsonObjet);
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())){
                ...
                if (TextUtils.isEmpty(urlImagen)){
                    ...
                    notificationUtils.showNotificationMessage(titulo,mensaje,timeStamp,resultIntent,urlImagen);
                }
            }
